...
2. Tiếp theo, hãy cập nhật phương thức `run` để liệt kê khả năng server:
...
2. Hãy xem cách cập nhật code hiện có để tận dụng hàm trên:
...
2. Tiếp theo, thêm hàm dùng để gọi LLM:
...
2. Bước cuối cùng, xem liệu LLM có nghĩ chúng ta nên gọi hàm nào không:
